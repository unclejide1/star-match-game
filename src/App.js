...
const StarsDisplay = (props) => (
  <>
 {utils.range(1, props.stars).map(starId => <div key = {starId} className = "star"></div>)}
    </>
)
    ...
    <div className="game"> 
      ...
      <div className="body">
        <div className="left">
          ...
          {gameStatus !== 'active' ? (
          <PlayAgain onClick = {props.startNewGame} gameStatus = {gameStatus}/>) : (<StarsDisplay stars = {stars}/>)}
